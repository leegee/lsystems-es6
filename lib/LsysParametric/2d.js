...
define(function(require, exports, module) {
    ...
    function Lsys (options) {
        this.options = {
    		...
    		variables :           '',
    		rulesIn :              null,
    		mergeDuplicateNotes :    1,
    		duration :            48,
    		scale :               'pentatonic',
    		initialDecimalNote : 58,
    		canvasWidth :         2000,
    		canvasHeight :        800,
    		angle :                30,
    		turtleStepX :        10,
    	...
    	console.debug('Variables: %O\nRules In:\n%O', this.variables, this.options.rulesIn);
    }
    ...
    exports.prototype.initialize = function (options) {
        ...
        this.ctx = this.ctx || this.options.canvas.getContext("2d");

    	this.colour = this.options.hasOwnProperty('colours')?
            this.options.colours[ 0 ] : '#000000';
        ...
        this.x = this.y = this.min_x = this.min_y = this.max_x = this.max_y = 0;
    ...
    exports.prototype.turtle_graph = function (dir) {
    	...
    	if (this.options.time_scale_lines > 0) {
            this.ctx.lineWidth = this.options.lineWidthPixels;
    	}
        else if (this.options.lineWidthPixels) {
    		this.ctx.lineWidth = this.options.lineWidthPixels;
    	}
    ...
    exports.prototype.setColour = function (index) {
    	this.ctx.strokeStyle = this.colour = this.options.colours[ index ];
    };
    ...
    exports.prototype.resize = function () {
        ...
        if (this.min_y < 0) {
            ...
            this.y = this.options.init_y || parseInt(this.options.canvasHeight / 2);
            this.y -= this.min_y;
        }
