...
exports.prototype.turtle_graph = function ( dir ) {
	...
	if ( this.options.time_scale_lines > 0 ) {
		this.ctx.lineWidth = this.options.turtle_step_x - ( this.stepped * this.options.time_scale_lines );
		console.log( 'LINE WIDTH: this.stepped=%d, %d', this.stepped, this.ctx.lineWidth )
