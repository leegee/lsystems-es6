...
define(function(require, exports, module) {
    ...
    function Lsys (options) {
        ...
        console.debug('Rules In:', this.options.rulesIn);
    }
    ...
    */
    ...
    exports.prototype.generate = function (generations) {
        this.options.generations = generations || this.options.generations || 1;

        console.debug('Enter to create %d generations', this.options.generations);

        this.content = this.options.start;
        this.content = this.interploateVars(this.content);

        for (
            this.generation = 1; this.generation <= this.options.generations; this.generation++
        ) {
            this.applyRules();
        }
    ...
    exports.prototype.applyRules = function () {
        ...
        console.log(
            '# FINAL for generation ' + this.generation + '/' + this.options.generations +
