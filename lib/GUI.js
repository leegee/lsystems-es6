...
define(function(require, exports, module) {
    ...
    exports.prototype.lsystems = [];

    exports.prototype.addLsys = function (Lsys, options) {
        options = options || {};
        var id = new GUID().create();
        var lsysOptions = {};
        ...
        if (! lsysOptions.hasOwnProperty('canvas')){
            ...
            lsysOptions.canvas.setAttribute('id', id+'canvas' );
    ...
    exports.prototype.run = function (options) {
        ...
        this.lsystems.forEach( function (lsys) {
            var generations = options.generations || lsys.options.generations || 2 ;
